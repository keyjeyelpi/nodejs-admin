...
const kanbanRoutes = async (fastify: FastifyInstance) => {
  ...
  }>("/board/:id", { preHandler: [authenticateJWT] }, getBoardById);

  fastify.get<{
    Params: {
      id: string;
    };
  }>("/:id", { preHandler: [authenticateJWT] }, getKanbanBoardById);

  fastify.post<{
    Body: {
      name?: string;
    };
  }>("/", { preHandler: [authenticateJWT, signature] }, createBoard);
  ...
  }>("/:id", { preHandler: [authenticateJWT, signature] }, updateBoard);

  fastify.delete<{
    Params: {
      id: string;
    };
  }>("/:id", { preHandler: [authenticateJWT, signature] }, deleteBoard);
  ...
  }>("/column/:id", { preHandler: [authenticateJWT, signature] }, updateColumn);
  ...
  fastify.put<{
    ...
    Body: Record<string, unknown>;
  }>("/card/:id", { preHandler: [authenticateJWT, signature] }, updateCard);

  fastify.delete<{
    Params: {
      id: string;
    };
  }>("/column/:id", { preHandler: [authenticateJWT, signature] }, deleteColumn);

  fastify.delete<{
    Params: {
      id: string;
    };
  }>("/card/:id", { preHandler: [authenticateJWT, signature] }, deleteCard);
  ...
  }>("/comment", { preHandler: [authenticateJWT, signature] }, addComment);
