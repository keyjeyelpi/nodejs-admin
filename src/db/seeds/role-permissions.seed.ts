...
export async function seed() {
    ...
    if (rolesList.length === 0 || permissionsList.length === 0) {
        console.error("No roles or permissions found. Please run roles.seed.ts and permissions.seed.ts first.");
        process.exit(1);
    }
